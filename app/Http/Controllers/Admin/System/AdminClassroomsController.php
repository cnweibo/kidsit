...
namespace Kidsit\Http\Controllers\Admin\System;
...
use Kidsit\Models\System\Classroom;

class AdminClassroomsController extends Controller
{
    /**
    ...
    {
        $title = "班级管理";
        return View::make('admin.system.classrooms.index',compact('title'));
    }
