...
class UserController extends Controller
{
    ...
    public function postEdit($user)
    {
        ...
        if ($user->isValid())
        {
            ...
            // Save if valid.(amend of confide is obselete) Password field will be hashed before save
            $user->save();
        }
    ...
    {
        $user = \Auth::user();
        // \Confide::logAttempt( $input, true );
        \Lang::get('confide::confide.username_e_mail');
        if(!empty($user->id)){
            return Redirect::to('/');
        }
    ...
    public function getConfirm( $code )
    {
        ...
        {
            return Redirect::to('user/login')
                ->with( 'notice', Lang::get('confide.alerts.confirmation') );
        }
        else
        {
            return Redirect::to('user/login')
                ->with( 'error', Lang::get('confide.alerts.wrong_confirmation') );
        }
    }
    ...
    public function postForgot()
    {
        ...
        {
            return Redirect::to('user/login')
                ->with( 'notice', Lang::get('confide.alerts.password_forgot') );
        }
        else
        {
            return Redirect::to('user/forgot')
                ->withInput()
                ->with( 'error', Lang::get('confide.alerts.wrong_password_forgot') );
        }
    }
    ...
    public function postReset()
    {
        ...
        {
            return Redirect::to('user/login')
            ->with( 'notice', Lang::get('confide.alerts.password_reset') );
        }
        else
        {
            return Redirect::to('user/reset/'.$input['token'])
                ->withInput()
                ->with( 'error', Lang::get('confide.alerts.wrong_password_reset') );
        }
    }
