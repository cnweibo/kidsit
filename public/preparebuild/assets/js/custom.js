...
Modernizr.load({
	...
	yep :['/preparebuild/assets/css/touch.css?v=1'],
	nope: ['/preparebuild/assets/nonbowerlibs/waypoint/waypoints.min.js'],
	complete : function () {
		if (Modernizr.touch){
			//initMobile
...
//   }
// })
// handle the scroll in view animation

						// $( '.my-animated-row' ).each( function(i) {
						// 	var $el = $( this );
						// 	$el.waypoint( function( direction ) {
						// 		if( direction === 'down') {
						// 			$('.list.start-1').addClass('fadeInUp');
