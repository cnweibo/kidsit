        ...
        mathskillcatListCtrl.$inject = ['$scope','$window','toastr','$location','khttp','$q','simplevalidate'];
            ...
            function mathskillcatListCtrl($scope,$window,toastr,$location,khttp,$q,simplevalidate) {
                ...
                vm.deleteMathskillcat = function(mathskillcat){
                    ...
                    khttp.destroy(basetempurl+"/admin/api/math/skillcat/",mathskillcat).then(
                ...
                var returned = simplevalidate.dovalidate(rules,data,
                                                        basetempurl+'/admin/api/math/skillcat/');
                returned.then(
                    function (response) {
                        if (response){
                            // already exist
                            ...
                            vm.currentPromise = promise = khttp.update(basetempurl+"/admin/api/math/skillcat/"+mathskillcat.id,mathskillcat);
                            promise.then(
                ...
                vm.loadMathskillcatSelectableOwners = function () {
                    khttp.getAll(basetempurl+"/admin/api/math/skillcat").then(
