    ...
    angular
        ...
        mathskillListCtrl.$inject = ['$scope','$window','toastr','$location','khttp','$q','simplevalidate'];
            ...
            function mathskillListCtrl($scope,$window,toastr,$location,khttp,$q,simplevalidate) {
                ...
                var vm = this;
                var promise;
                vm.currentPromise = promise = khttp.getAll(basetempurl+"/admin/api/math/skill");
                promise.then(
                ...
                vm.currentPromise = promise = khttp.getAll(basetempurl+"/admin/api/math/skillcat");
                promise.then(
                ...
                vm.deleteMathskill = function(mathskill){
                    ...
                    khttp.destroy(basetempurl+"/admin/api/math/skill/",mathskill).then(
                ...
                vm.saveMathskill = function(mathskill){
                    var d = $q.defer();
                    vm.currentPromise = promise = khttp.update(basetempurl+"/admin/api/math/skill/"+mathskill.id,mathskill);
                    promise.then(
                ...
                var queryurl;
                if (field=="catlabel"){
                    queryurl =basetempurl+'/admin/api/math/skill/?catsubid='+mathskill.catsubid+'&mathskillcat_id='+_.findWhere($scope.mathskillcats,{catlabel:data}).id;
                }else if (field=="catsubid"){
                    queryurl = basetempurl+'/admin/api/math/skill/?catsubid='+ data +'&mathskillcat_id='+mathskill.category.id;
                }else{
                    vm.currentPromise = promise = khttp.update(basetempurl+"/admin/api/math/skill/"+mathskill.id,mathskill);
                    promise.then(
                        function(mathskilldata) {/*success*/
                        ...
                        if (response){
                            ...
                            if (field=="catlabel"){
                                if(mathskill.category){
                                    ...
                                    mathskill.category = {
                                        catlabel: data,
                                        id: _.findWhere($scope.mathskillcats,{catlabel:data}).id
                                    };
                                }
                ...
                vm.loadMathskillSelectableOwners = function () {
                    khttp.getAll(basetempurl+"/admin/api/math/skill").then(
