...
(function () {
	...
	angular.module('teacherApp',['ngRoute','khttp','xeditable','toastr','ui.utils','containerCtrl','simplevalidate','darthwade.loading'])
		...
		.config( ['$routeProvider','$interpolateProvider','toastrConfig', function ($routeProvider,$interpolateProvider,toastrConfig) {
			...
			$routeProvider.when('/create', {templateUrl: basetempurl+ '/htmlapp/system/teacher/partials/create.html', controller: 'teacherCreateCtrl'});
			$routeProvider.when('/teacher-list', {templateUrl: basetempurl+ '/htmlapp/system/teacher/partials/index.html'});
