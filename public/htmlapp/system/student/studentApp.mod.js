...
(function () {
    ...
    document.write('<base href=' + basetempurl + '/admin/system/student' +'/>');
	...
	angular.module('studentApp',['ngRoute','khttp','cgBusy','xeditable','toastr','ui.utils','containerCtrl','ui.bootstrap','angular.filter'])
		...
		.config( ['$routeProvider','$interpolateProvider','toastrConfig', function ($routeProvider,$interpolateProvider,toastrConfig) {
			...
			$routeProvider.when('/create', {templateUrl: basetempurl+'/htmlapp/system/student/partials/create.html', controller: 'studentCreateCtrl'});
			$routeProvider.when('/student-list', {templateUrl: basetempurl+'/htmlapp/system/student/partials/index.html'});
			$routeProvider.when('/student-detail/:id', {templateUrl: basetempurl+'/htmlapp/system/student/partials/show.html', controller: 'studentDetailCtrl'});
