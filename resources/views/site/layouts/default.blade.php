...
@show
		...
		<link rel="stylesheet" href="{{asset('preparebuild/assets/libs/PACE/themes/blue/pace-theme-barber-shop.css')}}">
		<!-- pacejs -->
		<script>
			var paceOptions = {
			  ajax: false, // disabled
		...
		<script type="text/javascript" src="{{asset('preparebuild/assets/libs/PACE/pace.js')}}"></script>
		<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
		<!--[if lt IE 9]>
		  <script src="{{asset('preparebuild/assets/libs/html5shiv.js')}}"></script>
		  <script src="{{asset('preparebuild/assets/libs/respond.min.js')}}"></script>		  
		<![endif]-->
