<div id="carousel_id" class="carousel slide">
    ...
    <div class="item active">
		<img src="{{asset('build/images/littletreeSmall.jpg')}}" class="carouselimg" alt="">
    ...
    <div class="item"> 
		<img src="{{asset('build/images/internet.jpg')}}" class="carouselimg" alt="互联网那点事">
		<div class="carousel-caption">
		<h4>让IT成为宝贝的必备技能</h4>
		<p>“计算机从娃娃抓起。” IT宝贝网倡导并践行适合中国学生的信息教育</p>
		<p>让IT技能成为中国学生的生存必备技能，成就学生的IT范儿</p>
	
	</div>
	</div>
    <div class="item">
		<img src="{{asset('build/images/LearnIT.png')}}" class="carouselimg" alt="">
		<div class="carousel-caption">
		<h4>IT技术辅助日常学习</h4>
		<p>现代IT技术发展带来学习的革命，网络也让学生获取信息更加简洁便利</p>
		<p>IT宝贝网践行现代化的IT技术辅助学生的日常学习，</p>
		<p>让学习不仅高效而且有趣</p>
		</div>
	</div>
	</div>
